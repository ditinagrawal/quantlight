...
<html class="no-js" lang="zxx">
  <head>
    ...
    <title>{{ $category->name }} | SmartPath Edu</title>
    <meta name="description" content="Browse all {{ $category->name }} blogs" />
    ...
    <div class="it-offcanvas-area">
      <div class="itoffcanvas">
        ...
        <div class="itoffcanvas__logo">
          <a href="/">
            <img src="/quantlight/assets/img/logo/logo.png" alt="" style="width: 100px" />
          </a>
        </div>
            ...
            <div class="row align-items-center">
              <div class="col-xl-2 col-6">
                <div class="it-header-5-logo">
                  <a href="/">
                    <img
                      src="/quantlight/assets/img/logo/logo.png"
                      alt="Logo"
                    ...
                    <div class="postbox__thumb-box mb-80">
                      ...
                      <div class="postbox__content-box">
                        <div class="postbox__meta">
                          <span><i class="fa-light fa-calendar-days"></i>{{ $blog->created_at->format('F d, Y') }}</span>
                          <span><i class="fal fa-user"></i>{{ $blog->category?->name ?? 'News' }}</span>
                        </div>
                        ...
                        @endif
                        <a class="it-btn mt-15" href="{{ url('/news/' . $blog->slug) }}">
                          <span>
                            read more
              ...
              <div class="it-sv-details-sidebar">
                <div class="sidebar__widget mb-55">
                  <div class="sidebar__widge-title-box">
                    <h3 class="sidebar__widget-title pb-10">Categories</h3>
                  </div>
                  <div class="sidebar__widget-content">
                    <div class="it-sv-details-sidebar-category-wrapper">
                      @php
                        $allBlogsCount = \App\Models\Blog::where('is_published', true)->count();
                      @endphp
                      ...
                      @if($categories->count() > 0)
                        @foreach($categories as $categoryItem)
                          <a href="{{ route('news.category', $categoryItem->slug) }}" class="it-sv-details-sidebar-category mb-10 {{ $category->id === $categoryItem->id ? 'active' : '' }}" style="display: block; text-decoration: none; color: inherit;">
                            <span>{{ $categoryItem->name }} <span style="color: #999; font-weight: normal;">({{ $categoryItem->blogs_count }})</span></span>
                          </a>
                        @endforeach
                      @else
