...
<html class="no-js" lang="zxx">
  <head>
    ...
    <title>{{ $blog->title }} | SmartPath Edu</title>
    ...
    <meta property="og:title" content="{{ $blog->title }} | SmartPath Edu" />
    <meta property="og:description" content="{{ Str::limit(strip_tags($blog->excerpt ?? $blog->content), 200) }}" />
    @if($blog->image_url)
    ...
    <meta property="twitter:url" content="{{ url('/news/' . $blog->slug) }}" />
    <meta property="twitter:title" content="{{ $blog->title }} | SmartPath Edu" />
    <meta property="twitter:description" content="{{ Str::limit(strip_tags($blog->excerpt ?? $blog->content), 200) }}" />
    @if($blog->image_url)
    <meta property="twitter:image" content="{{ $blog->image_url }}" />
    @endif
    
    <!-- Canonical URL -->
    <link rel="canonical" href="{{ url('/news/' . $blog->slug) }}" />
